...
public class ShoppingCart {
    ...
    private JLabel lblMop;
    private Object_RoundedButton btnCod;
    private Object_RoundedButton btnOnlinePayment;
    private Object_RoundedButton btnCredit;
    private Object_RoundedButton btnDebit;
    private JLabel lblTotalPrice;

    private JLabel btnBack;
    private Object_RoundedButton btnOrder;
    ...
    public ShoppingCart() {
        ...
        lblShoppingCart.setPreferredSize(new Dimension(600, 50));
        headerPanel.add(lblShoppingCart);
        layout.putConstraint(SpringLayout.WEST, lblShoppingCart, 30, SpringLayout.WEST, headerPanel);
        layout.putConstraint(SpringLayout.NORTH, lblShoppingCart, 20, SpringLayout.NORTH, headerPanel);
        ...
        lblDeliveryAddress = new JLabel();
        footerPanel.add(lblDeliveryAddress);
        layout.putConstraint(SpringLayout.WEST, lblDeliveryAddress, 10, SpringLayout.WEST, footerPanel);
